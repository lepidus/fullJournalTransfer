...
import('plugins.importexport.fullJournalTransfer.filter.export.FullJournalArticleNativeXmlFilter');

class FullJournalArticleNativeXmlFilterTest extends NativeImportExportFilterTestCase
{
    ...
    {
        return 'full-journal-article=>native-xml';
    }

    protected function getNativeImportExportFilterClass()
    {
        return FullJournalArticleNativeXmlFilter::class;
    }
