...
namespace APP\plugins\importexport\fullJournalTransfer\tests\unit\roundTrip;
...
class RoundTripRunnerTest extends TestCase
{
    ...
    public function testItVerifiesTheCommittedFixture(): void
    {
        $process = $this->runFixture(
            dirname(__DIR__, 2) . '/round-trip/fixture-ojs-3.4.0.10-v1.tar.gz',
            dirname(__DIR__, 2) . '/round-trip/expected-ojs-3.4.0.10-v1.json'
        );
    ...
    public function testItPrintsTheExplicitRestorationPlanWithoutChangingTheEnvironment(): void
    {
        ...
        $process = new Process([
            PHP_BINARY,
            dirname(__DIR__, 2) . '/round-trip/run',
            '--fixture',
            $fixture,
            '--expected',
            $expected,
